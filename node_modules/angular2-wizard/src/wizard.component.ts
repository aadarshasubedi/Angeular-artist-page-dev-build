...
@Component({
  ...
  `<div class="card">
    ...
    <div class="card-footer" [hidden]="isCompleted">
        <button type="button" class="btn btn-secondary float-left" (click)="previous()" [hidden]="!hasPrevStep || !activeStep.showPrev">Back</button>
  ...
  styles: [
    '.card { height: 100%; }',
    '.card-header { background-color: none; padding: 0; font-size: 1.25rem; }',
    '.card-block { overflow-y: auto; }',
    '.card-footer { background-color: none; border-top: 0 none; }',
